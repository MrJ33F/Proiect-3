...
import com.aie.game.GameComponents.GameUI.Inventory.InventoryItemLocation;
import com.aie.game.GameComponents.GameUI.Inventory.InventoryUI;
...
public class StoreInventoryUI extends Window implements InventorySlotObserver, StoreInventorySubject {
    ...
    private Array<com.aie.game.GameComponents.GameUI.Inventory.Store.StoreInventoryObserver> observers;
        ...
        buyButton.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                if(fullValue > 0 && playerTotal >= fullValue) {
                    ...
                    StoreInventoryUI.this.notify(Integer.toString(playerTotal), com.aie.game.GameComponents.GameUI.Inventory.Store.StoreInventoryObserver.StoreInventoryEvent.PLAYER_GP_TOTAL_UPDATED);
                    fullValue = 0;
    ...
    public void savePlayerInventory() {
        ...
        StoreInventoryUI.this.notify(json.toJson(playerItemsInPlayerInventory), com.aie.game.GameComponents.GameUI.Inventory.Store.StoreInventoryObserver.StoreInventoryEvent.PLAYER_INVENTORY_UPDATED);
    }
    ...
    @Override
    public void addObserver(com.aie.game.GameComponents.GameUI.Inventory.Store.StoreInventoryObserver storeObserver) {
        observers.add(storeObserver);
    }

    @Override
    public void removeObserver(com.aie.game.GameComponents.GameUI.Inventory.Store.StoreInventoryObserver storeObserver) {
        observers.removeValue(storeObserver, true);
    }

    @Override
    public void removeAllObservers() {
        for(com.aie.game.GameComponents.GameUI.Inventory.Store.StoreInventoryObserver observer: observers) {
            observers.removeValue(observer, true);
        }
    }

    @Override
    public void notify(String value, com.aie.game.GameComponents.GameUI.Inventory.Store.StoreInventoryObserver.StoreInventoryEvent event) {
        for(com.aie.game.GameComponents.GameUI.Inventory.Store.StoreInventoryObserver observer: observers) {
